    ...
    <>
      ...
      <div className="mt-16 flex flex-col w-full py-6 font-arimo text-[#1F2F3D]">
        <div className="w-[85%] h-full self-center">
          ...
          {screen > 7
            ? FormSelector(documents["documents"][screen - 8])
