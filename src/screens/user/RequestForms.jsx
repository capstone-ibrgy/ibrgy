                ...
                <div className={`flex flex-col w-[80%] rounded-[20px] bg-[#D9D9D9]`}>
                    <div className='relative flex flex-row w-full h-16 bg-[#1F2F3D]  rounded-[20px] items-center px-6 gap-6'>
                        ...
                        <div className='absolute right-[-1px] rounded-[20px] w-32 h-full bg-[#FEC51C] py-3 px-6'>
                            <h1 className='font-bold text-lg text-center leading-tight'>COST: {documents.price} Php</h1>
                        </div>
                    </div>
                    <form onSubmit={(e) => { handleSubmit(e) }} className='flex flex-col w-full flex-1 px-6 py-4 gap-2'>
                                ...
                                fields.map((item, i) => {
                                    return (
                                        <div className='flex-1 flex flex-col'>
                                            <label className='font-bold text-[#1F2F3D] text-sm pb-1'>{item.label}</label>
                                            <input value={fields[i].value} required={true} onChange={(e) => {
                                                let temp = [...fields];
