        ...
        <div className="relative flex flex-col w-full bg-white rounded-t-[20px] text-white">
          ...
          <div className="flex flex-row w-full gap-8 px-8 py-24 pb-8">
            <div className="flex flex-col w-full gap-2">
              <p className="text-[#1F2F3D] font-bold text-lg">
                ...
                return (
                  <div className="flex flex-col w-full font-semibold text-[#1F2F3D]">
                    ...
                    <input
                      readOnly
                      type="text"
                      placeholder={info_left.current}
                      className="border-2 border-[#1F2F3D] placeholder-[#1B75BC] truncate rounded-lg h-10 p-2"
                    />
                  </div>
                );
              })}
            ...
            <div className="flex flex-col w-full gap-2">
                ...
                return (
                  <div className="flex flex-col w-full font-semibold text-[#1F2F3D]">
                    ...
                    <input
                      readOnly
                      type="text"
                      placeholder={info_right.current}
                      className="border-2 border-[#1F2F3D] placeholder-[#1B75BC] truncate rounded-lg h-10 p-2"
                    />
                  </div>
                );
              })}
              <p className="pt-4 pb-2 text-[#1F2F3D] font-bold text-lg">
                Included Document
              </p>
              <div
                onClick={() => {
              ...
              <div className="flex flex-row w-full h-full items-end gap-4 font-bold text-[#1F2F3D] pt-4">
                <button
                  ...
                  className="border-2 border-[#FEC51C] bg-white w-full p-4 rounded-lg drop-shadow-lg"
                >
                  Deny Request
                </button>
                <button
                  ...
                  className="border-2 border-[#FEC51C] bg-[#FEC51C] w-full p-4 rounded-lg drop-shadow-lg"
                >
                  Confirm Request
                </button>
              </div>
