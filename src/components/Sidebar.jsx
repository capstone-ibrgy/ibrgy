          ...
          return (
            <>
              <div
                ...
                key={`${items}1#${i}`}
                className={`relative cursor-pointer flex flex-row items-center h-14 px-4 w-full text-white border-b gap-3 
                            ${
              ...
              {side && onService && i === 2 && (
                <div
                  key={`${items}2#${i}`}
                  className="flex h-[200px] flex-col border-b transition-all ease-in-out duration-500 overflow-auto"
                >
